...
namespace nilnul.time_.datetime.lex_.num_
{
	/// <summary>
	/// 
	/// </summary>
	...
	/// alias:
	///		year8pair
	public class YrInTwo : nilnul.time_.datetime.PhraseA
		,nilnul.time_.datetime.ParseI
	{
		...
		/// </summary>
		public static string Format = "yyMMddHHmmss" + nilnul.txt.op_.RepeatX.Repeat("f", 7); //little f means trailing nils are kept;
