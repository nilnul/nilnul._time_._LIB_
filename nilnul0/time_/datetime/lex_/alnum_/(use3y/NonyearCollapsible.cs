...
namespace nilnul.time_.datetime.lex_.verse_
{
	/// <summary>
	/// year in four digits;
	/// </summary>
	public class NonyearCollapsible :
		...
		nilnul.time_.datetime.ParseI
	{
		...
		public const string FORMAT = @"yyy\yMMddHHmmss\sFFFFFFF"; // "F..." discards trailing zeros
		...
		public DateTime parse(string x1111)
		{
			...
			yrAftSb.Insert(0, x1111.Substring(0, yIndex + 1));
		...
		static public NonyearCollapsible Singleton
		{
			get
			{
				return nilnul._obj.typ_.nilable_.unprimable_.Singleton<NonyearCollapsible>.Instance;
			}
		}
